...
The remaining-scope figure is a judgement, as S1's were. Under this paragraph's rule, the ADR weighing ADR-0014's and NFR-S-02's options is drafted before M3 starts. That, or a challenge to the scaling, is the maintainer's call. S1's reduction 1 (the element reaches no hydrate, snapshot or restore code) matters more now: that is exactly M3's code.
